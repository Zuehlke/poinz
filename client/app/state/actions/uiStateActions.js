...
export const MAINVIEW_TOGGLED = 'MAINVIEW_TOGGLED';
export const STORY_HIGHLIGHTED = 'STORY_HIGHLIGHTED';
...
export const highlightStory = (storyId) => ({type: STORY_HIGHLIGHTED, storyId});
...
export const toggleMainView = (mainViewKey) => ({type: MAINVIEW_TOGGLED, mainViewKey});
export const MAINVIEW_ROOM = 'ROOM';
export const MAINVIEW_MATRIX = 'MATRIX';
export const MAINVIEW_DETAIL = 'DETAIL';
