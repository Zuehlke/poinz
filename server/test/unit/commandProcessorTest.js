...
test('process a dummy command successfully: create room', () => {
...
test('process a dummy command successfully: room loading by alias', () => {
  const roomStore = newMockRoomsStore({
    id: 'someId',
    alias: 'super-duper-alias'
  });
  const processor = processorFactory(
    {
      setUsername: {
